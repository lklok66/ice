...
public final class ConnectionI extends IceInternal.EventHandler implements Connection
{
    ...
    finalize()
        throws Throwable
    {
	IceUtil.Assert.Assert(_state == StateClosed);
	IceUtil.Assert.Assert(_transceiver == null);
	IceUtil.Assert.Assert(_dispatchCount == 0);
	IceUtil.Assert.Assert(_threadPerConnection == null);
	IceUtil.Assert.Assert(_incomingCache == null);
