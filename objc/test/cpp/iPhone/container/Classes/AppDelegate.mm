...
int adapterDeactivationServer(int argc, char** argv);
int adapterDeactivationClient(int argc, char** argv);
...
static const struct TestCases alltests[] =
{
    ...
    { @"defaultServant", 0, defaultServantClient },
    ...
    { @"interceptor", 0, interceptorClient },
