...
#include <SlicingExceptionsTest.h>
...
public:
    ...
    exception_baseAsBase(const Ice::Exception& exc)
    {
        ...
        {
            test(b.b == "Base.b");
            test(b.ice_name() =="Test::Slicing::Exceptions::Base");
        }
        catch(...)
        {
            test(false);
    ...
    exception_knownDerivedAsBase(const Ice::Exception& exc)
    {
        ...
        catch(const KnownDerived& k)
        {
            ...
            test(k.ice_name() =="Test::Slicing::Exceptions::KnownDerived");
        }
        catch(...)
        {
            test(false);
    ...
    exception_knownIntermediateAsBase(const Ice::Exception& exc)
    {
        ...
        catch(const KnownIntermediate& ki)
        {
            ...
            test(ki.ice_name() =="Test::Slicing::Exceptions::KnownIntermediate");
        }
        catch(...)
        {
            test(false);
    ...
    exception_knownMostDerivedAsBase(const Ice::Exception& exc)
    {
        ...
        catch(const KnownMostDerived& kmd)
        {
            ...
            test(kmd.ice_name() =="Test::Slicing::Exceptions::KnownMostDerived");
        }
        catch(...)
        {
            test(false);
    ...
    exception_unknownMostDerived1AsBase(const Ice::Exception& exc)
    {
        ...
        catch(const KnownIntermediate& ki)
        {
            ...
            //test(string(ki.ice_name()) =="Test::Slicing::Exceptions::KnownIntermediate");
        }
        catch(...)
        {
            test(false);
...
TestIntfPrx
slicingExceptionsAllTests(const Ice::CommunicatorPtr& communicator)
{
    ...
    tprintf("base (AMI)... ");
    {
        ...
        test->begin_baseAsBase(newCallback_TestIntf_baseAsBase(cb, &Callback::response, &Callback::exception_baseAsBase));
        cb->check();
    }
    tprintf("ok\n");
