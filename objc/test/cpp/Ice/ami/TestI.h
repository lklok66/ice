...
namespace Test
{
    ...
    namespace AMI
    {
        ...
        class TestIntfI : virtual public Test::AMI::TestIntf, public IceUtil::Monitor<IceUtil::Mutex>
        {
        public:
        ...
        class TestIntfControllerI : public Test::AMI::TestIntfController, IceUtil::Monitor<IceUtil::Mutex>
        {
        public:
