...
public:
    ...
    {
        test(result->getCookie() == _cookie);
        test(result->getProxy()->end_ice_id(result) == Test::AMI::TestIntf::ice_staticId());
        called();
    }
    ...
    {
        test(result->getCookie() == _cookie);
        Test::AMI::TestIntfPrx::uncheckedCast(result->getProxy())->end_op(result);
        called();
    }
    ...
    {
        test(result->getCookie() == _cookie);
        test(Test::AMI::TestIntfPrx::uncheckedCast(result->getProxy())->end_opWithResult(result) == 15);
        called();
    }
    ...
    void opWithUE(const Ice::AsyncResultPtr& result)
    {
        ...
        try
        {
            Test::AMI::TestIntfPrx::uncheckedCast(result->getProxy())->end_opWithUE(result);
            test(false);
        }
        catch(const Test::AMI::TestIntfException&)
        {
            called();
        }
...
public:
    ...
    {
        test(id == Test::AMI::TestIntf::ice_staticId());
        called();
    }
...
public:
    ...
    void opWithUE(const Ice::Exception& ex)
    {
        test(dynamic_cast<const Test::AMI::TestIntfException*>(&ex));
        called();
    }
...
void
amiAllTests(const Ice::CommunicatorPtr& communicator)
{
    string sref = "test:default -p 12010";
    Ice::ObjectPrx obj = communicator->stringToProxy(sref);
    test(obj);
    
    Test::AMI::TestIntfPrx p = Test::AMI::TestIntfPrx::uncheckedCast(obj);
    
    sref = "testController:tcp -p 12011";
    obj = communicator->stringToProxy(sref);
    test(obj);
    
    Test::AMI::TestIntfControllerPrx testController = Test::AMI::TestIntfControllerPrx::uncheckedCast(obj);
    ...
    tprintf("testing begin/end invocation... ");
    {
        ...
        result = p->begin_ice_isA(Test::AMI::TestIntf::ice_staticId());
        test(p->end_ice_isA(result));
        result = p->begin_ice_isA(Test::AMI::TestIntf::ice_staticId(), ctx);
        test(p->end_ice_isA(result));
        ...
        test(p->end_ice_id(result) == Test::AMI::TestIntf::ice_staticId());
    ...
    tprintf("testing async callback... ");
    {
        ...
        p->begin_ice_isA(Test::AMI::TestIntf::ice_staticId(), Ice::newCallback(cb, &AsyncCallback::isA));
        cb->check();
        p->begin_ice_isA(Test::AMI::TestIntf::ice_staticId(), Ice::newCallback(cbWC, &AsyncCallback::isA), cookie);
        cbWC->check();
        p->begin_ice_isA(Test::AMI::TestIntf::ice_staticId(), ctx, Ice::newCallback(cb, &AsyncCallback::isA));
        cb->check();
        p->begin_ice_isA(Test::AMI::TestIntf::ice_staticId(), ctx, Ice::newCallback(cbWC, &AsyncCallback::isA), cookie);
        cbWC->check();
    ...
    tprintf("testing response callback... ");
    {
        ...
        p->begin_ice_isA(Test::AMI::TestIntf::ice_staticId(), Ice::newCallback_Object_ice_isA(cb, &ResponseCallback::isA,
                                                                                         nullEx));
        cb->check();
        p->begin_ice_isA(Test::AMI::TestIntf::ice_staticId(),
                         Ice::newCallback_Object_ice_isA(cbWC, &ResponseCallbackWC::isA, nullExWC), cookie);
        cbWC->check();
        p->begin_ice_isA(Test::AMI::TestIntf::ice_staticId(), ctx,
        ...
        p->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &ResponseCallback::op, nullEx));
        cb->check();
        p->begin_op(Test::AMI::newCallback_TestIntf_op(cbWC, &ResponseCallbackWC::op, nullExWC), cookie);
        cbWC->check();
        p->begin_op(ctx, Test::AMI::newCallback_TestIntf_op(cb, &ResponseCallback::op, nullEx));
        cb->check();
        p->begin_op(ctx, Test::AMI::newCallback_TestIntf_op(cbWC, &ResponseCallbackWC::op, nullExWC), cookie);
        cbWC->check();
        
        p->begin_opWithResult(Test::AMI::newCallback_TestIntf_opWithResult(cb, &ResponseCallback::opWithResult, nullEx));
        cb->check();
        p->begin_opWithResult(Test::AMI::newCallback_TestIntf_opWithResult(cbWC, &ResponseCallbackWC::opWithResult,
                                                                      nullExWC), cookie);
        cbWC->check();
        p->begin_opWithResult(ctx, Test::AMI::newCallback_TestIntf_opWithResult(cb, &ResponseCallback::opWithResult,
                                                                           nullEx));
        cb->check();
        p->begin_opWithResult(ctx, Test::AMI::newCallback_TestIntf_opWithResult(cbWC, &ResponseCallbackWC::opWithResult,
                                                                           nullExWC), cookie);
        cbWC->check();
        
        p->begin_opWithUE(Test::AMI::newCallback_TestIntf_opWithUE(cb, &ResponseCallback::op, &ResponseCallback::opWithUE));
        cb->check();
        p->begin_opWithUE(Test::AMI::newCallback_TestIntf_opWithUE(cbWC, &ResponseCallbackWC::op,
                                                              &ResponseCallbackWC::opWithUE), cookie);
        cbWC->check();
        p->begin_opWithUE(ctx, Test::AMI::newCallback_TestIntf_opWithUE(cb, &ResponseCallback::op,
                                                                   &ResponseCallback::opWithUE));
        cb->check();
        p->begin_opWithUE(ctx, Test::AMI::newCallback_TestIntf_opWithUE(cbWC, &ResponseCallbackWC::op,
                                                                   &ResponseCallbackWC::opWithUE), cookie);
        cbWC->check();
    }
    tprintf("ok\n");
    ...
    {
        Test::AMI::TestIntfPrx indirect = Test::AMI::TestIntfPrx::uncheckedCast(p->ice_adapterId("dummy"));
        ...
        Test::AMI::TestIntfPrx p2 = Test::AMI::TestIntfPrx::checkedCast(obj);
        ic->destroy();
    ...
    tprintf("testing local exceptions with async callback... ");
    {
        Test::AMI::TestIntfPrx i = Test::AMI::TestIntfPrx::uncheckedCast(p->ice_adapterId("dummy"));
        AsyncCallbackPtr cb = new AsyncCallback();
        CookiePtr cookie = new Cookie(5);
        AsyncCallbackPtr cbWC = new AsyncCallback(cookie);
        
        i->begin_ice_isA(Test::AMI::TestIntf::ice_staticId(), Ice::newCallback(cb, &AsyncCallback::isAEx));
        cb->check();
        i->begin_ice_isA(Test::AMI::TestIntf::ice_staticId(), Ice::newCallback(cbWC, &AsyncCallback::isAEx), cookie);
        cbWC->check();
    ...
    tprintf("testing local exceptions with response callback... ");
    {
        ...
        i->begin_ice_isA(Test::AMI::TestIntf::ice_staticId(),
        ...
        i->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &ExceptionCallback::op, &ExceptionCallback::ex));
        cb->check();
        i->begin_op(Test::AMI::newCallback_TestIntf_op(cbWC, &ExceptionCallbackWC::op, &ExceptionCallbackWC::ex), cookie);
        cbWC->check();
    }
    tprintf("ok\n");
    ...
    tprintf("testing exception callback... ");
    {
        ...
        i->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &ExceptionCallback::ex));
        cb->check();
        i->begin_op(Test::AMI::newCallback_TestIntf_op(cbWC, &ExceptionCallbackWC::ex), cookie);
        cbWC->check();
        
        // Operations that return a result must provide the response callback
        //i->begin_opWithResult(Test::AMI::newCallback_TestIntf_opWithResult(cb, &ExceptionCallback::ex));
        //cb->check();
        //i->begin_opWithResult(Test::AMI::newCallback_TestIntf_opWithResult(cbWC, &ExceptionCallbackWC::ex), cookie);
        //cbWC->check();
        
        i->begin_opWithUE(Test::AMI::newCallback_TestIntf_opWithUE(cb, &ExceptionCallback::ex));
        cb->check();
        i->begin_opWithUE(Test::AMI::newCallback_TestIntf_opWithUE(cbWC, &ExceptionCallbackWC::ex), cookie);
        cbWC->check();
        ...
        p->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &ExceptionCallback::noEx));
        p->begin_op(Test::AMI::newCallback_TestIntf_op(cbWC, &ExceptionCallbackWC::noEx), cookie);
        //p->begin_opWithResult(Test::AMI::newCallback_TestIntf_opWithResult(cb, &ExceptionCallback::noEx));
        //p->begin_opWithResult(Test::AMI::newCallback_TestIntf_opWithResult(cbWC, &ExceptionCallbackWC::noEx), cookie);
        
        // If response is a user exception, it should be received.
        p->begin_opWithUE(Test::AMI::newCallback_TestIntf_opWithUE(cb, &ExceptionCallback::opWithUE));
        cb->check();
        
        p->begin_opWithUE(Test::AMI::newCallback_TestIntf_opWithUE(cbWC, &ExceptionCallbackWC::opWithUE), cookie);
        cbWC->check();
    }
    tprintf("ok\n");
    ...
    tprintf("testing sent callback... ");
    {
        ...
        p->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &SentCallback::op, &SentCallback::ex, &SentCallback::sent));
        cb->check();
        p->begin_op(Test::AMI::newCallback_TestIntf_op(cbWC, &SentCallback::opWC, &SentCallback::exWC,
                                                  &SentCallback::sentWC), cookie);
        cbWC->check();
        ...
        p->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &SentCallback::ex, &SentCallback::sent));
        cb->check();
        p->begin_op(Test::AMI::newCallback_TestIntf_op(cbWC, &SentCallback::exWC, &SentCallback::sentWC), cookie);
        cbWC->check();
        ...
        {
            cb = new SentCallback();
            while(p->begin_opWithPayload(seq, Test::AMI::newCallback_TestIntf_opWithPayload(
    ...
    tprintf("testing illegal arguments... ");
    {
        ...
        try
        {
            p->begin_op(Test::AMI::newCallback_TestIntf_op(ResponseCallbackPtr(), &ResponseCallback::op,
                                                      &ResponseCallback::ex));
            test(false);
        }
        catch(const IceUtil::IllegalArgumentException&)
        ...
        try
        {
            p->begin_op(Test::AMI::newCallback_TestIntf_op(ResponseCallbackWCPtr(), &ResponseCallbackWC::op,
        ...
        try
        {
            ...
            p->begin_op(Test::AMI::newCallback_TestIntf_op(new ResponseCallback, nullCallback, nullExCallback));
            test(false);
        }
        catch(const IceUtil::IllegalArgumentException&)
        {
        ...
        {
            ResponseCallbackPtr cb = new ResponseCallback();
            p->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &ResponseCallback::op, &ResponseCallback::ex), new Cookie(3));
            test(false);
        }
        catch(const IceUtil::IllegalArgumentException&)
        {
        ...
        try
        {
            ...
            p->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &ResponseCallbackWC::op, &ResponseCallbackWC::ex),
                        new Ice::LocalObject());
            test(false);
        }
        catch(const IceUtil::IllegalArgumentException&)
    ...
    {
        Test::AMI::TestIntfPrx q = Test::AMI::TestIntfPrx::uncheckedCast(p->ice_adapterId("dummy"));
        ...
        for(int i = 0; i < 4; ++i)
        {
            ...
            p->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &Thrower::op, &Thrower::noEx));
            cb->check();
            
            p->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &Thrower::opWC, &Thrower::noExWC), cookie);
            cb->check();
            
            q->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &Thrower::op, &Thrower::ex));
            cb->check();
            
            q->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &Thrower::opWC, &Thrower::exWC), cookie);
            cb->check();
            
            p->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &Thrower::noOp, &Thrower::ex, &Thrower::sent));
            cb->check();
            
            p->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &Thrower::noOpWC, &Thrower::exWC, &Thrower::sentWC), cookie);
            cb->check();
            
            q->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &Thrower::ex));
            cb->check();
            
            q->begin_op(Test::AMI::newCallback_TestIntf_op(cb, &Thrower::exWC), cookie);
            cb->check();
        }
    }
    tprintf("ok\n");
    ...
    tprintf("testing batch requests with proxy... ");
    {
        ...
        
        {
            ...
            Test::AMI::TestIntfPrx b1 = p->ice_batchOneway();
            b1->opBatch();
            b1->opBatch();
    ...
    tprintf("testing batch requests with communicator... ");
    {
        ...
        
        {
            ...
            test(p->opBatchCount() == 0);
            Test::AMI::TestIntfPrx b1 = p->ice_batchOneway();
            Test::AMI::TestIntfPrx b2 = p->ice_connectionId("2")->ice_batchOneway();
