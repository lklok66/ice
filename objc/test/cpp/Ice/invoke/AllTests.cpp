...
public:
    ...
    void opException(const Ice::AsyncResultPtr& result)
    {
        ...
        else
        {
            ...
            catch(const Test::Invoke::MyException&)
            {
                called();
            }
            catch(...)
...
Test::Invoke::MyClassPrx
invokeAllTests(const Ice::CommunicatorPtr& communicator)
{
    string ref = "test:default -p 12010";
    Ice::ObjectPrx base = communicator->stringToProxy(ref);
    test(base);
    
    Test::Invoke::MyClassPrx cl = Test::Invoke::MyClassPrx::uncheckedCast(base);
    test(cl);
    
    Test::Invoke::MyClassPrx oneway = cl->ice_oneway();
