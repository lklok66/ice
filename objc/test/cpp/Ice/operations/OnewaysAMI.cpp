...
namespace
{
    ...
    class AMI_MyClass_onewayOpVoidI : public Test::Operations::AMI_MyClass_opVoid, public CallbackBase
    {
    public:
    ...
    class AMI_MyClass_onewayOpIdempotentI : public Test::Operations::AMI_MyClass_opIdempotent, public CallbackBase
    {
    public:
    ...
    class AMI_MyClass_onewayOpNonmutatingI : public Test::Operations::AMI_MyClass_opNonmutating, public CallbackBase
    {
    public:
    ...
    class AMI_MyClass_onewayOpVoidExI : public Test::Operations::AMI_MyClass_opVoid, public CallbackBase
    {
    public:
    ...
    class AMI_MyClass_onewayOpByteExI : public Test::Operations::AMI_MyClass_opByte, public CallbackBase
    {
    public:
...
void
onewaysAMI(const Ice::CommunicatorPtr& communicator, const Test::Operations::MyClassPrx& proxy)
{
