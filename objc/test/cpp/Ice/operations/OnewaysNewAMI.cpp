...
void
onewaysNewAMI(const Ice::CommunicatorPtr& communicator, const Test::Operations::MyClassPrx& proxy)
{
    ...
    
    {
        try
        {
            p->begin_ice_isA(Test::Operations::MyClass::ice_staticId());
            test(false);
        }
    ...
    {
        CallbackPtr cb = new Callback;
        Test::Operations::Callback_MyClass_opVoidPtr callback =
        Test::Operations::newCallback_MyClass_opVoid(cb, &Callback::noException, &Callback::sent);
    ...
    
    {
        ...
        Test::Operations::newCallback_MyClass_opIdempotent(cb, &Callback::noException, &Callback::sent);
    ...
    
    {
        ...
        Test::Operations::newCallback_MyClass_opNonmutating(cb, &Callback::noException, &Callback::sent);
