...
namespace
{
    ...
    public:
        ...
        PerThreadContextInvokeThread(const Test::Operations::MyClassPrx& proxy) : _proxy(proxy)
        {
        }
    ...
    private:
        ...
        Test::Operations::MyClassPrx _proxy;
    };
    
}

void
twoways(const Ice::CommunicatorPtr& communicator, const Test::Operations::MyClassPrx& p)
{
    {
        p->ice_ping();
    }
    ...
    {
        test(p->ice_isA(Test::Operations::MyClass::ice_staticId()));
    }
    
    {
        test(p->ice_id() == Test::Operations::MyDerivedClass::ice_staticId());
    }
    ...
    {
        Test::Operations::MyEnum e;
        Test::Operations::MyEnum r;
        
        r = p->opMyEnum(Test::Operations::enum2, e);
        test(e == Test::Operations::enum2);
        test(r == Test::Operations::enum3);
    }
    
    {
        Test::Operations::MyClassPrx c1;
        Test::Operations::MyClassPrx c2;
        Test::Operations::MyClassPrx r;
    ...
    
    {
        ...
        Test::Operations::Structure so;
        Test::Operations::Structure rso = p->opStruct(si1, si2, so);
        test(rso.p == 0);
    ...
    
    {
        ...
        Test::Operations::ByteS bso;
        Test::Operations::ByteS rso;
    ...
    
    {
        ...
        Test::Operations::BoolS bso;
        Test::Operations::BoolS rso;
    ...
    
    {
        ...
        Test::Operations::ShortS sso;
        Test::Operations::IntS iso;
        Test::Operations::LongS lso;
        Test::Operations::LongS rso;
    ...
    
    {
        ...
        Test::Operations::FloatS fso;
        Test::Operations::DoubleS dso;
        Test::Operations::DoubleS rso;
    ...
    
    {
        ...
        Test::Operations::StringS sso;
        Test::Operations::StringS rso;
    ...
    
    {
        ...
        Test::Operations::ByteSS bso;
        Test::Operations::ByteSS rso;
    ...
    
    {
        ...
        Test::Operations::FloatSS fso;
        Test::Operations::DoubleSS dso;
        Test::Operations::DoubleSS rso;
    ...
    
    {
        ...
        Test::Operations::StringSS sso;
        Test::Operations::StringSS rso;
    ...
    {
        Test::Operations::StringSSS sssi1;
        sssi1.resize(2);
        sssi1[0].resize(2);
        ...
        Test::Operations::StringSSS sssi2;
        sssi2.resize(3);
        sssi2[0].resize(2);
        sssi2[0][0].push_back("");
        sssi2[0][0].push_back("");
        ...
        Test::Operations::StringSSS ssso;
        Test::Operations::StringSSS rsso;
    ...
    
    {
        ...
        Test::Operations::ByteBoolD _do;
        Test::Operations::ByteBoolD ro = p->opByteBoolD(di1, di2, _do);
    ...
    
    {
        ...
        Test::Operations::ShortIntD _do;
        Test::Operations::ShortIntD ro = p->opShortIntD(di1, di2, _do);
    ...
    
    {
        ...
        Test::Operations::LongFloatD _do;
        Test::Operations::LongFloatD ro = p->opLongFloatD(di1, di2, _do);
    ...
    
    {
        ...
        Test::Operations::StringStringD _do;
        Test::Operations::StringStringD ro = p->opStringStringD(di1, di2, _do);
    ...
    
    {
        ...
        Test::Operations::StringMyEnumD _do;
        Test::Operations::StringMyEnumD ro = p->opStringMyEnumD(di1, di2, _do);
        
        test(_do == di1);
        test(ro.size() == 4);
        test(ro["abc"] == Test::Operations::enum1);
        test(ro["qwerty"] == Test::Operations::enum3);
        test(ro[""] == Test::Operations::enum2);
        test(ro["Hello!!"] == Test::Operations::enum2);
    }
    
    {
        ...
        Test::Operations::MyEnumStringD _do;
        Test::Operations::MyEnumStringD ro = p->opMyEnumStringD(di1, di2, _do);
        
        test(_do == di1);
        test(ro.size() == 3);
        test(ro[Test::Operations::enum1] == "abc");
        test(ro[Test::Operations::enum2] == "Hello!!");
        test(ro[Test::Operations::enum3] == "qwerty");
    }
    
    {
        ...
        Test::Operations::MyStructMyEnumD _do;
        Test::Operations::MyStructMyEnumD ro = p->opMyStructMyEnumD(di1, di2, _do);
        
        test(_do == di1);
        test(ro.size() == 4);
        test(ro[s11] == Test::Operations::enum1);
        test(ro[s12] == Test::Operations::enum2);
        test(ro[s22] == Test::Operations::enum3);
        test(ro[s23] == Test::Operations::enum2);
    }
    
    {
        ...
        for(unsigned int l = 0; l != sizeof(lengths) / sizeof(*lengths); ++l)
        {
            ...
            Test::Operations::IntS r = p->opIntS(s);
    ...
    
    {
        ...
        ctx["three"] = "THREE";
        {
            Test::Operations::StringStringD r = p->opContext();
            test(p->ice_getContext().empty());
            test(r != ctx);
        }
        {
            Test::Operations::StringStringD r = p->opContext(ctx);
            test(p->ice_getContext().empty());
            test(r == ctx);
        }
        {
            ...
            Test::Operations::StringStringD r = p2->opContext();
            test(r == ctx);
            r = p2->opContext(ctx);
            test(r == ctx);
        }
