...
using namespace std;
using namespace Test::Exceptions;
...
ThrowerPrx
exceptionsAllTests(const Ice::CommunicatorPtr& communicator, bool collocated)
{
    tprintf("testing ice_print()/what()... ");
    {
        A a;
        string aMsg = "Test::Exceptions::A";
    ...
    tprintf("testing servant locator registrations exceptions... ");
    {
    ...
    tprintf("testing asynchronous exceptions... ");
    ...
    if(!collocated)
    {
        ...
        tprintf("catching exact types with new AMI mapping... ");
        ...
        tprintf("catching derived types with new AMI mapping... ");
        ...
        if(thrower->supportsUndeclaredExceptions())
        {
            tprintf("catching unknown user exception with new AMI mapping... ");
        ...
        tprintf("catching object not exist exception with new AMI mapping... ");
        ...
        tprintf("catching facet not exist exception with new AMI mapping... ");
        ...
        tprintf("catching operation not exist exception with new AMI mapping... ");
        ...
        tprintf("catching unknown local exception with new AMI mapping... ");
        ...
        tprintf("catching unknown non-Ice exception with new AMI mapping... ");
