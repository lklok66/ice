...
class ServerLocatorRegistry : public Test::Location::TestLocatorRegistry
{
public:
...
class ServerLocator : public Test::Location::TestLocator
{
public:
    
    ServerLocator(const ::Test::Location::ServerLocatorRegistryPtr&, const ::Ice::LocatorRegistryPrx&);
...
private:
    ...
    ::Test::Location::ServerLocatorRegistryPtr _registry;
