...
{
    { 
        TestNewAMIOperationsCallback* cb = [[[TestNewAMIOperationsCallback alloc] init] autorelease];
	...
	}
	{
	    ...
	    test([[p2 ice_getContext] isEqual:ctx]);
            ...
            cb = [[[TestNewAMIOperationsCallback alloc] init] autorelease];
