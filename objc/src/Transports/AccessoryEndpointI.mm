...
{
    // This shouldn't be called as IceTouch doesn't implement endpoint local interface.
    assert(false);
    return 0;
}
...
vector<ConnectorPtr>
IceObjC::AccessoryEndpointI::connectors() const
{
...
void
IceObjC::AccessoryEndpointI::connectors_async(const EndpointI_connectorsPtr& callback) const
{
    try
    {
