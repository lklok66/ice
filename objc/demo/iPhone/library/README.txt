...
implemented using Java and JDBC. This application provides an
graphical interface to a library server. It permits you to:

  - Create and Delete books
  - Query for books by isbn, author or title.
  - Rent and return books.

ZeroC hosts a server for this demo on demo2.zeroc.com.  The demo, by
default, connects with this host. The deployment on demo2.zeroc.com
