...
if [[ -f "/var/db/receipts/com.zeroc.icetouch122.preflight.pkg.bom" ]]; then
    rm "/var/db/receipts/com.zeroc.icetouch122.preflight.pkg.bom"
    rm "/var/db/receipts/com.zeroc.icetouch122.preflight.pkg.plist"
fi
