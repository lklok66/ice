This installer installs the following components in /Library/Developer/IceTouch-1.2.1:
 ...
 - Xcode 4.3 Objective-C SDKs for Mac OS X, iPhone iOS, iPhone Simulator
 - Xcode 4.3 C++ SDKs for Mac OS X, iPhone iOS, iPhone Simulator
 - Xcode 4.3 Plug-in for use with Ice Touch
 - Documentation
