...
1) You can use a server from any Ice language mapping, befofe start
   ...
   Hello.Endpoints, update it to contain the following:

   Hello.Endpoints=tcp -p 4502

2) start the hello server, following instructions in the demo REAMDE
...
4) From visual studio start hello.web project, using 
