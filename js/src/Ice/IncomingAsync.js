...
(function(){
    ...
    var IncomingAsync = function(instance, connection, adapter, response, compress, requestId)
    {
    ...
    IncomingAsync.prototype.__startWriteParams = function(format)
    {
        if(this._response)
        {
    ...
    IncomingAsync.prototype.__endWriteParams = function(ok)
    {
        if(this._response)
        {
    ...
    IncomingAsync.prototype.__writeEmptyParams = function()
    {
        if(this._response)
        {
            Debug.assert(this._os.size === Protocol.headerSize + 4); // Reply status position.
    ...
    IncomingAsync.prototype.__writeParamEncaps = function(v, ok)
    {
        if(this._response)
        {
            Debug.assert(this._os.size === Protocol.headerSize + 4); // Reply status position.
    ...
    IncomingAsync.prototype.__writeUserException = function(ex, format)
    {
    ...
    IncomingAsync.prototype.__warning = function(ex)
    {
    ...
    IncomingAsync.prototype.__servantLocatorFinished = function()
    {
    ...
    IncomingAsync.prototype.__handleException = function(ex)
    {
        Debug.assert(this._connection !== null);
    ...
    IncomingAsync.prototype.invoke = function(servantManager, stream)
    {
        this._is = stream;
...
console.log(ex.stack);
    ...
    IncomingAsync.prototype.startReadParams = function()
    {
        //
    ...
    IncomingAsync.prototype.endReadParams = function()
    {
        this._is.endReadEncaps();
    };

    IncomingAsync.prototype.readEmptyParams = function()
    {
        this._current.encoding = new Ice.EncodingVersion();
        this._is.skipEmptyEncaps(this._current.encoding);
    };

    IncomingAsync.prototype.readParamEncaps = function()
    {
        this._current.encoding = new Ice.EncodingVersion();
        return this._is.readEncaps(this._current.encoding);
    };

    IncomingAsync.prototype.ice_exception = function(ex)
    {
        if(this._connection !== null)
        {
            this.__exception(ex);
    ...
    IncomingAsync.prototype.__response = function()
    {
        try
        {
            if(this._locator !== null && !this.__servantLocatorFinished())
    ...
    IncomingAsync.prototype.__exception = function(exc)
    {
        try
        {
            if(this._locator !== null && !this.__servantLocatorFinished())
