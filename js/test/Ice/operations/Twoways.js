            ...
            try
            {
                ...
                p.ice_ping().then(
                    ...
                    function(r, retval, ssso)
                    {
                        ...
                        var di1 = new Ice.HashMap();
                        di1.set(10, true);
                        di1.set(100, false);
                        var di2 = new Ice.HashMap();
                        di2.set(10, true);
                        di2.set(11, false);
                        di2.set(101, true);
                    ...
                    function(r, retval, p3)
                    {
                        ...
                        var di1 = new Ice.HashMap();
                        di1.keyComparator = Ice.HashMap.compareEquals;
                        di1.set(new Ice.Long(0, 999999110), -1.1);
                        di1.set(new Ice.Long(0, 999999111), 123123.2);
                        var di2 = new Ice.HashMap();
                        di2.keyComparator = Ice.HashMap.compareEquals;
                    ...
                    function(r, c)
                    {
                        ...
                        var prxContext = new Ice.HashMap();
                        prxContext.set("one", "UN");
                        prxContext.set("four", "QUATRE");

                        combined = new Ice.HashMap(ctx);
