...
var Test = require("./ProxyTest").Test;
...
{
    this._log.print("testing stringToProxy... ");
    ...
    this._log.print("testing propertyToProxy... ");
    ...
    this._log.print("testing proxyToProperty... ");
    ...
    this._log.print("testing ice_getCommunicator... ");
    this.test(base.ice_getCommunicator() === this._communicator);
    this._log.print("ok\n");

    this._log.print("testing proxy methods... ");
    ...
    this._log.print("testing proxy comparison... ");
    ...
    this._log.print("testing checked cast... ");
    var self = this;
...
{
    this._log.print("exception occurred in call to " + r.operation + "\n");
    if(typeof(ex.stack) !== undefined)
    {
        this._log.print(ex.stack + "\n");
    }
...
{
    c = Ice.initialize();
    var allTests = new AllTests(c, logger);
    allTests.start().then(
        function()
        {
            cleanup(c);
