...
# ADD LINK32 Ice.lib Slice.lib IceUtil.lib python25.lib /nologo /dll /machine:I386 /libpath:"$(ICE_HOME)\lib" /export:initIcePy
...
# ADD LINK32 Iced.lib Sliced.lib IceUtild.lib python25_d.lib /nologo /dll /debug /machine:I386 /out:"Debug/IcePy_d.dll" /libpath:"$(ICE_HOME)\lib" /export:initIcePy
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
